...
for table_name in table_names:
    ...
    config_values[5] = f"bronze.manual_data.{table_name}"  # Update the source_table_prefix

    # Formulate the SQL query with the updated values
    sql_query = f"INSERT INTO administrative.silver.configuration_tables (database_name, schema_name,table_name, partition_table, primary_key, source_table, active, created_date, overwrite_data) VALUES {tuple(config_values)};"
