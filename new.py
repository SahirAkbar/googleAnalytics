...
credentials_info = {
    ...
    "universe_domain": "googleapis.com"  # Your credentials_info here...
}

dimensions = ['user_pseudo_id']  # Using 'user_pseudo_id' to count unique users
metrics = ['activeUsers']
...
def format_response(response):
    ...
    columns += [metric.name for metric in response.metric_headers]
